...
import { attachmentEditService } from "services/attachments/attachment-edit.service";
import { logger } from "services/winston-logger/logger.service";

export async function adminAttachmentEditController(
  req: Request,
  res: Response
) {
  ...
  logger.info(`Admin <${req.currentUser!.id}> edited an uploaded file info successfully`,
