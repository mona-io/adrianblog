  ...
  body("firstName")
    ...
    .withMessage(
      validationMsgSerializer(
        ...
        AuthLocaleEnum.ERROR_SCHEMA_SIGNUP_FIRSTNAME
      )
    ),
  body("lastName")
    .trim()
    ...
    .withMessage(
      validationMsgSerializer(
        ...
        AuthLocaleEnum.ERROR_SCHEMA_SIGNUP_LASTNAME
      )
    ),
  body("email")
    .isEmail()
    .withMessage(
      validationMsgSerializer(
        "Email must be valid",
        AuthLocaleEnum.ERROR_SCHEMA_SIGNUP_EMAIL
      )
    ),
  body("password")
    .trim()
    ...
    .withMessage(
      validationMsgSerializer(
        ...
        AuthLocaleEnum.ERROR_SCHEMA_WEAK_PASSWORD
      )
    )
    .not()
    .equals("Passw0rd")
