...
import {
  docListGenerator,
  IListQueryPreDefinedFilters,
  IListQueryPreDefinedOrders,
} from "infrastructure/service-utils/doc-list-generator";
...
export async function attachmentListService(params: IAttachmentListService) {
  const { fieldsToExclude, query, preDefinedFilters, preDefinedOrders } =
    params;
